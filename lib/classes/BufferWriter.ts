...
export class BufferWriter {
  ...
  private writeNumber(data: number | bigint, size: number, unsigned: boolean) {
    switch (size) {
      ...
      case 2:
        unsigned
          ? this.writeUInt16(Number(data))
          : this.writeInt16(Number(data));
        break;
      case 4:
        unsigned
          ? this.writeUInt32(Number(data))
          : this.writeInt32(Number(data));
        break;
      case 8:
        unsigned
          ? this.writeUInt64(BigInt(data))
          : this.writeInt64(BigInt(data));
        break;
      default:
  ...
  public writeInt16(data: number) {
    ...
    this._endian === Endian.Little
      ? tmpBuffer.writeInt16LE(data)
      : tmpBuffer.writeInt16BE(data);
    this.appendBuffer(tmpBuffer);
  }
  ...
  public writeInt32(data: number) {
    ...
    const tmpBuffer = Buffer.alloc(size);
    this._endian === Endian.Little
      ? tmpBuffer.writeInt32LE(data)
      : tmpBuffer.writeInt32BE(data);
    this.appendBuffer(tmpBuffer);
  }
  ...
  public writeInt64(data: bigint) {
    ...
    const tmpBuffer = Buffer.alloc(size);
    this._endian === Endian.Little
      ? tmpBuffer.writeBigInt64LE(data)
      : tmpBuffer.writeBigInt64BE(data);
    this.appendBuffer(tmpBuffer);
  }
  ...
  public writeUInt16(data: number) {
    ...
    const tmpBuffer = Buffer.alloc(size);
    this._endian === Endian.Little
      ? tmpBuffer.writeUInt16LE(data)
      : tmpBuffer.writeUInt16BE(data);
    this.appendBuffer(tmpBuffer);
  }
  ...
  public writeUInt32(data: number) {
    ...
    const tmpBuffer = Buffer.alloc(size);
    this._endian === Endian.Little
      ? tmpBuffer.writeUInt32LE(data)
      : tmpBuffer.writeUInt32BE(data);
    this.appendBuffer(tmpBuffer);
  }
  ...
  public writeUInt64(data: bigint) {
    ...
    const tmpBuffer = Buffer.alloc(size);
    this._endian === Endian.Little
      ? tmpBuffer.writeBigUInt64LE(data)
      : tmpBuffer.writeBigUInt64BE(data);
    this.appendBuffer(tmpBuffer);
  }
  ...
  public writeFloat(data: number) {
    ...
    const tmpBuffer = Buffer.alloc(size);
    this._endian === Endian.Little
      ? tmpBuffer.writeFloatLE(data)
      : tmpBuffer.writeFloatBE(data);
    this.appendBuffer(tmpBuffer);
  }
  ...
  public writeDouble(data: number) {
    ...
    const tmpBuffer = Buffer.alloc(size);
    this._endian === Endian.Little
      ? tmpBuffer.writeDoubleLE(data)
      : tmpBuffer.writeDoubleBE(data);
    this.appendBuffer(tmpBuffer);
  }
